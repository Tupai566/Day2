...
Hello Microverse is my first project I created it using HTML and CSS
...
```sh
  cd my-folder
  git clone git@github.com:Tupai566/Day2.git
```
--->
...
I would like to thank Microverse and Omar(CR).
...
This project is [MIT](./LICENSgitE) licensed.
